...
public class MCreatorSoulOfRange extends Elementscryptors_arms_mod.ModElement {
	@GameRegistry.ObjectHolder("cryptors_arms_mod:soulofrange")
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("cryptors_arms_mod", "entitybulletsoulofrange"), ENTITYID).name("entitybulletsoulofrange")
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("cryptors_arms_mod:soulofrange", "inventory"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(MCreatorSoulShooted.block, (int) (1)).getItem(), Minecraft.getMinecraft()
					.getRenderItem());
		});
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(0);
			setFull3D();
			setUnlocalizedName("soulofrange");
			setRegistryName("soulofrange");
			maxStackSize = 1;
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(MCreatorSoulShooted.block, (int) (1)).getItem()
							&& stack.getMetadata() == new ItemStack(MCreatorSoulShooted.block, (int) (1)).getMetadata()) {
						slotID = i;
						break;
					}
				}
				if (entity.capabilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					...
					if (entity.capabilities.isCreativeMode) {
						...
						if (new ItemStack(MCreatorSoulShooted.block, (int) (1)).isItemStackDamageable()) {
							...
							entity.inventory.clearMatchingItems(new ItemStack(MCreatorSoulShooted.block, (int) (1)).getItem(), -1, 1, null);
						}
					}
					if (!world.isRemote)
						world.spawnEntity(entityarrow);
					{
						...
						MCreatorSoulOfRangeRangedItemUsed.executeProcedure($_dependencies);
					}
				}
			}
		}
